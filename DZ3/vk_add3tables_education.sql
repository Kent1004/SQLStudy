...
CREATE TABLE `university` (
  ...
  `university_city` varchar(120) DEFAULT NULL,
  UNIQUE KEY `id` (`id`),
...
CREATE TABLE `user_education` (
  ...
  `school_end_year` year DEFAULT NULL,
  `university_id` bigint unsigned DEFAULT NULL,
  `university_end_year` year DEFAULT NULL,
  ...
  CONSTRAINT `user_education_ibfk_2` FOREIGN KEY (`school_id`) REFERENCES `school` (`id`),
  CONSTRAINT `user_education_ibfk_3` FOREIGN KEY (`university_id`) REFERENCES `university` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-02-01  0:51:06
